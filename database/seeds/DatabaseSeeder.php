...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        MaterialCategory::create(['mc_name' => 'Dal']);
         ...
         Material::create(['material_name' => '92 Ginnie','material_category_id'=>1,'gold'=>92,'silver'=>0,'is_main_production_material'=>1,'is_base_material'=>1]);
         Material::create(['material_name' => 'Pan','material_category_id'=>1,'gold'=>40,'silver'=>20,'is_main_production_material'=>1,'is_base_material'=>0]);
