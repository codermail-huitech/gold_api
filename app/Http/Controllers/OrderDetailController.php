...
//        return response()->json(['success'=>1,'data'=>$request->input('orderMasterId')], 200,[],JSON_NUMERIC_CHECK);
        $data=OrderDetail::select('order_details.job_status','order_details.material_id','order_details.id','order_details.price','order_details.size','order_details.approx_gold','order_details.p_loss','order_details.quantity','products.model_number',DB::raw("price_codes.price_code_name as price_code"),DB::raw("products.id as product_id"),DB::raw("order_details.quantity * order_details.price as  amount"))
